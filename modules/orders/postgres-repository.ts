    ...
    validateOrderItem(
      {
        ...
        orderId: text(row.order_id, 'order_id'),
        listingId: optionalText(row.listing_id, 'listing_id'),
        versionId: optionalText(row.version_id, 'version_id'),
        commerceUnitTypeId: optionalText(row.commerce_unit_type_id, 'commerce_unit_type_id'),
        quoteId: optionalText(row.quote_id, 'quote_id'),
        lineKind: text(row.line_kind, 'line_kind'),
