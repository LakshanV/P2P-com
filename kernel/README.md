...
**Nine components have implemented foundations.** K-05 and K-08 are build step B-1; K-01, K-02,
K-03, K-04, K-07 and K-09 are B-2, which is covered; K-06 Policy Engine opens **B-3**. The kernel's internal chain is `K-01 → K-02/K-03 → K-04`, and **every
...
**The remaining 6 components are unbuilt**, and every one of them is build step B-3 or later:
B-1 and B-2 are both covered, and K-06 is the first of B-3. Their
