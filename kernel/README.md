...
**Seven components have implemented foundations.** K-05 and K-08 are build step B-1; K-01, K-02,
K-03, K-04 and K-09 are B-2. The kernel's internal chain is `K-01 → K-02/K-03 → K-04`, and **every
...
**The remaining 8 components are unbuilt**; build steps B-1 through B-3 populate them. Their
