...
**474 tracked items** carry an explicit status. Counts verified mechanically over this file after FND-005b, which moved the K-06 contract to COMPLETE and the K-06 implementation to IN PROGRESS — two rows out of NOT STARTED, and **build step B-3 opened**. FND-004e before it moved the K-07 contract to COMPLETE and the K-07 implementation and P0-37 to IN PROGRESS, covering B-2. FND-004d before it moved the K-04 contract to COMPLETE and the K-04 implementation, P0-34, X-03, X-04 and X-20 to IN PROGRESS; its three corrections (§11.27–§11.29) changed no status and added no row. The method is reproducible and is asserted by `tests/status-docs.test.ts`: count one status marker per status-bearing cell of every row in sections A–G and J whose first cell is an item id. §H and §I are registers rather than tracked requirements and are excluded, which is what makes the section table below sum to the same 474.

| Status | Count | Notes |
|---|---:|---|
| `[ ]` NOT STARTED | 410 | |
| `[~]` IN PROGRESS | 36 | X-52 (standing documentation obligation); P0-04…P0-08 (satisfied by FND-001a, held while FND-001 is unfinished); P0-10 (four of eight MODULE_MAP §13 checks built); X-44 and X-46 (the checks exist but are not yet **CI** checks); P0-14, P0-15, P0-16 and RC-06 (FND-002a delivered the migration contract, FND-002b the runner, FND-002c local provisioning); P0-17 (seed and fixture foundation, never loaded); T-21 (test-database lifecycle delivered, never run); P0-35 and P0-36 (K-08 and K-09 cores); P0-38 (K-05's core; K-06 not started); **P0-33, X-01, X-02 and X-14 (K-02's core, with no verifier behind it and no HTTP surface in front of it)**; and the K-01, K-02, K-03, K-05, K-08 and K-09 implementation rows. Nothing has been executed against a live PostgreSQL. |
| `[?]` NEEDS REVIEW | 0 | Nothing has been submitted for review. |
| `[x]` COMPLETE | 14 | P0-01 (DOC-001 documentation artefacts), P0-03 (all six source roots tracked and documented), P0-11 (financial-zone and provider-import checks, proven by planted fixtures), P0-12 and P0-13 (contributor documentation and git conventions), and nine kernel module contracts — K-01, K-02, K-03, K-04, K-05, K-06, K-07, K-08 and K-09. A contract is a fixed public surface, not a delivered capability. |
