...
| ID | Requirement | Status | Evidence |
|---|---|---|---|
| P0-14 | Database selection and local provisioning | `[ ]` NOT STARTED | NONE |
| P0-15 | Migration system, forward and reversible where reasonable (v1 §92) | `[ ]` NOT STARTED | NONE |
| P0-16 | Schema-namespace-per-module convention enforced | `[ ]` NOT STARTED | NONE |
| P0-17 | Seed/fixture strategy for realistic-data testing (v3 §33) | `[ ]` NOT STARTED | NONE |
...
| RC-06 | v1 §92 database migration rules | `[ ]` NOT STARTED | Compatible with v3; adopted as the migration standard under P0-15. |
