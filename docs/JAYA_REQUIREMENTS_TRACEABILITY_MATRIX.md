...
- 100 migration files (50 forward, 50 rollback).
...
|---|---|---|---|---|
| AG-01 | Clean DB migration | `INTEGRATION TESTED` | 95% | 50 forward + 50 rollback, checksum reconciliation, advisory locking, per-migration atomicity. Every module's rollback is proven to leave no trace |
