...
- 98 migration files (49 forward, 49 rollback).
...
|---|---|---|---|---|
| AG-01 | Clean DB migration | `INTEGRATION TESTED` | 95% | 49 forward + 49 rollback, checksum reconciliation, advisory locking, per-migration atomicity. Every module's rollback is proven to leave no trace |
